var EBE_SubmitManager = function( optionVal ){
	var formEl = $(".common_rightPanel form");
	var inputEls = formEl.find("input[type!=hidden],select");
	var warnEls = formEl.find(".warn");
	
	formEl.find("option[value="+optionVal+"]").attr("selected",true);
